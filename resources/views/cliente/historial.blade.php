                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        @forelse($appointments as $appointment)
                            <tr>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-700">${{ number_format($appointment->service?->price ?? 0, 2) }}</td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm">
                                    <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium {{ $appointment->status === 'completed' ? 'bg-green-100 text-green-700' : 'bg-yellow-100 text-yellow-700' }}">
                        ...
                        @empty
                            <tr>
                                <td colspan="6" class="px-6 py-4 text-sm text-gray-500">Aún no tienes servicios en tu historial.</td>
                            </tr>
                        @endforelse
                    </tbody>
                </table>
